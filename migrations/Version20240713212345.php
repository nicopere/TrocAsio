 ...
 */
final class Version20240713212345 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE accounting_entry (id INT AUTO_INCREMENT NOT NULL, calculator_id INT DEFAULT NULL, date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', amount DOUBLE PRECISION NOT NULL, receipt_number INT DEFAULT NULL, name VARCHAR(255) NOT NULL, further_information VARCHAR(255) DEFAULT NULL, INDEX IDX_DB6C942AACF2C4B8 (calculator_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
